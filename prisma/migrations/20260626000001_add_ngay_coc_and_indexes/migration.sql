-- Migration: add ngay_coc to pipeline + 29 performance indexes
-- Applied directly via ALTER TABLE / CREATE INDEX before this migration file was created.
-- Marked as applied with: prisma migrate resolve --applied

-- ngay_coc was manually added to pipeline table
ALTER TABLE "pipeline" ADD COLUMN IF NOT EXISTS "ngay_coc" TEXT;
...
-- PayrollAdjustment
CREATE INDEX IF NOT EXISTS "payroll_adjustments_nv_thang_nam_idx"
  ON "payroll_adjustments"("id_nhan_vien", "thang", "nam");
...
-- TmNotification
CREATE INDEX IF NOT EXISTS "tm_notifications_user_id_status_idx"
  ON "tm_notifications"("user_id", "status");
